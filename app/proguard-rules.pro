...
# Apache POI and its logging stack include optional JVM/OSGi/AWT integrations that
# are not used by MedStock's Android registry parsers. R8 sees references to those
# optional classes during release shrinking, so suppress the missing-class warnings
# instead of disabling minification for the whole release build.
